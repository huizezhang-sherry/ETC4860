...
- Chen (2018) 
    ...
    - **Data collection**: Still images extracted from videos of US Supreme Court, voice audio, augment data on judges (gender, political views, past voting)
...
- Extract facial expression data from videos of High Court of Australia
--
...
- Provides an objective source of data to study the problem
--

- Do the results agree or disagree with Tutton's findings, that judges are appearing impartial?
