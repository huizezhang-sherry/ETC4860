...
**Do the justices' expression differ from case to case?** **Do the justices' expression differ when different parties are speaking?**
...
```{r model-plot, echo = FALSE, message = FALSE, warning = FALSE, fig.width=16, fig.height=12, out.width="100%", out.height="100%"}
...
```{r intensity, echo = FALSE, fig.height=10, fig.width=13}
...
- more frequent time interval i.e. 5 second,  could be used for more precise emotions
...
- [**emmeans**](https://CRAN.R-project.org/package=emmeans) for estimated marginal mean summary of the GLM model

- [**car**](http://socserv.socsci.mcmaster.ca/jfox/Books/Companion) for type III ANOVA test. 

- [**knitr**](https://yihui.name/knitr/) for pretty table display
---
class: center, middle
