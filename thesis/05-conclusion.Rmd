...
The analysis is conducted using R [@Rlanguage], and the following packages: forecast [@forecast], tidyverse [@tidyverse], emmenas [@emmeans] and broom [@broom]. This thesis document is created with knitr [@knitr], R Markdown [@rmarkdown] and bookdown [@bookdown]. All matrials required to reproduce the project can be found at https://github.com/huizezhang-sherry/ETC4860/. 
