...
The statistics being plotted in the graph is the percentage of presence and mathematically it can be written as $$P_{ik} = \frac{\sum_{jt}X_{ijtk}}{\sum_{j = 1}^JT_j}$$ 

The order of the action unit is based on $P_{k}$, that is, the aggregated percentage of presence across all the judge. 
...
![I_overall](images/I_overall.png)
