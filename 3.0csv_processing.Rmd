...
save(nauru_a,file = "data/nauru_a.rda")
...
save(temp_nauru-b,file = "data/temp_nauru_b.rda")

load("data/temp_nauru_b.rda")
...
temp_nauru_b_1 <- temp_nauru_b %>% select(-c(X_0 : Z_67, eye_lmk_x_0:eye_lmk_Z_55, p_scale:p_33))
...
save(nauru_b,file = "data/nauru_b.rda")
...
temp_McKell_1 <- temp_McKell %>% select(-c(X_0 : Z_67, eye_lmk_x_0:eye_lmk_Z_55, p_scale:p_33))
...
save(McKell,file = "data/McKell.rda")
...
temp_OKS_1 <- temp_OKS %>% select(-c(X_0 : Z_67, eye_lmk_x_0:eye_lmk_Z_55, p_scale:p_33))
...
temp_Parkes_1 <- temp_Parkes %>% select(-c(X_0 : Z_67, eye_lmk_x_0:eye_lmk_Z_55, p_scale:p_33))
...
save(Parkes,file = "data/Parkes.rda")
...
temp_Rinehart_a_1 <- temp_Rinehart_a %>% select(-c(X_0 : Z_67, eye_lmk_x_0:eye_lmk_Z_55, p_scale:p_33))
...
save(Rinehart_a,file = "data/Rinehart_a.rda")
...
temp_Rinehart_b_1 <- temp_Rinehart_b %>% select(-c(X_0 : Z_67, eye_lmk_x_0:eye_lmk_Z_55, p_scale:p_33))
...
save(Rinehart_b,file = "data/Rinehart_b.rda")
