...
# need to further think about the arranging of these plots 
# at least I find that AU02 although present with high frequency, is really low intense for all the judges
ggarrange(subplot[[1]], 
          subplot[[4]],
          subplot[[5]],
          ncol = 1, nrow = 3)
