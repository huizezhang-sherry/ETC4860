...
# Can we predict outcome of appeal based on facial pattern of the Justices?


[![A video for fun](data/nauru-a/nauru-a_003.png)](https://www.youtube.com/watch?v=Ae7uKzin0GA)
...
Speakers themselves can be unaware of their facial and vocal expressions 

- Chan (2018): 
  
 - used video and audio recordings to predict the court outcome using the Supreme Court data from the United States 
 
 - the image processing method is best for object detection, but is not specific for face recognition

- Tutton et al. (2018): 

  - using the transcript and AV recordings 
  
  - visually inspect the videos and take notes when the Justices display some facial expressions and the corresponding transcript.

---
# Face Recognition

- **Paul Ekman** studied facial actions and expressions, which led to the Facial Action Coding System (FACS)
...
- Kovalchik & Reid (2018) utilise OpenFace to study the emotion of professional tennis players in the Australian Open grand slam matches
...
Low confident results are still useful information, indicating a justice is looking away
...
## Transcript analysis: the counsel

Interrupted by the judges has a negative implication on the odd of winning the case (Johnson et al., 2009)

```{r r_a, echo = FALSE,  fig.align ="center", fig.width=10, fig.height=5}
...
Our data is consistent with previous literature!

---
# Plan 

- Data: 6 observations (videos), 700 variables (facial characteristics and meta information),  7 groups (judges)
...
- Model associations between outcomes and reduced variable set
