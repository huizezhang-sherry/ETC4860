...
# Can we predict the outcome of an appeal based on facial expression of the Justices?
...
---
# Existing legal studies on judicial behaviour

Judges are expected to be neutral in the courtroom, but they can be unaware they are making facial expressions. 

- Chan (2018): 
  
 - used video and audio recordings to predict the court outcome on the Supreme Court in the United States 
 
 - used general image processing methods, but not face recognition

- Tutton et al. (2018): 

  - uses transcript and AV recordings 
