...
Speakers themselves can be unaware of some facial and vocal expressions 

- Justices' decision through gender, number of questions asked

- Chan (2018): 
  
 - uses video and audio to predict the court outcome using the Supreme Court data from the United States 
 
 - image processing technology but is not specific to the face 
...
## 4601 CSVs and 711 facial variables!
---
class: middle, center
