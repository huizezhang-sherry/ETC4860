...
miss_case_talbe(au) # 1768 cases don't have missings while the other 2833 cases all have 35 missings in the case. 
...
au_imputed <- au_intensity %>% 
  left_join(au_presence, by = c("judge_id", "video_id", "frame_id", "speaker"))
